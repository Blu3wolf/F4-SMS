namespace F4SMS
{
    partial class MainMenu
    {
        ...
        private void InitializeComponent()
        {
			...
			// textBoxIssues
			// 
			this.textBoxIssues.Location = new System.Drawing.Point(0, 0);
			this.textBoxIssues.Name = "textBoxIssues";
			this.textBoxIssues.Size = new System.Drawing.Size(100, 20);
			this.textBoxIssues.TabIndex = 0;
			// 
			// richTextBoxIssues
			// 
			this.richTextBoxIssues.BackColor = System.Drawing.SystemColors.Control;
			this.richTextBoxIssues.BorderStyle = System.Windows.Forms.BorderStyle.None;
			this.richTextBoxIssues.Location = new System.Drawing.Point(12, 54);
			this.richTextBoxIssues.Name = "richTextBoxIssues";
			this.richTextBoxIssues.Size = new System.Drawing.Size(350, 55);
			this.richTextBoxIssues.TabIndex = 4;
			this.richTextBoxIssues.Text = "Thanks for checking out F4-SMS! To report a bug, click the link: https://github.c" +
    "om/Blu3wolf/F4-SMS/issues/new";
			this.richTextBoxIssues.LinkClicked += new System.Windows.Forms.LinkClickedEventHandler(this.richTextBoxIssues_LinkClicked);
			// 
			// MainMenu
			// 
